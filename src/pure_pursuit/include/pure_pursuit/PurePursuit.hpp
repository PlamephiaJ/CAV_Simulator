 ...
 * @LastEditTime: 2024-08-13 20:35:17
...
private:
    ...
    //////////////////////////////////////////////////////////////////////////
    rclcpp::TimerBase::SharedPtr temp_timer_ = nullptr;
    bool temp_flag_ = false;
    void func_timer()
    {
        temp_flag_ = true;
        auto aeb_msg = std::make_shared<std_msgs::msg::String>();
        aeb_msg->data = "AEB";
        AEB_callback(aeb_msg);
    }
