...
def generate_launch_description():
    ...
    right_wall_follow_node_car1 = Node(
        package='wall_follow',
    ...
    # left wall following
    left_wall_follow_node_car1 = Node(
        package='wall_follow',
    ...
    '''
    waypoint_recorder_sim_node_car1 = Node(
        package='auxiliary',
    ...
    waypoints_displayer_node_1 = Node(
        package='auxiliary',
    ...
    Pure pursuit
    '''
    pure_pursuit_sim_node_car1 = Node(
        ...
        parameters=[
            ...
            {'is_emergency_brake_publisher': False},
    ...
    # ld.add_action(left_wall_follow_node_car1)
    # ld.add_action(reactive_node_car1)
    # ld.add_action(waypoints_displayer_node_1)
    ld.add_action(pure_pursuit_sim_node_car1)
    # ld.add_action(rrt_sim_node_car1)
