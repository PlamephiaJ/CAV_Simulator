 ...
 * @LastEditTime: 2024-07-01 18:34:04
 * @FilePath: /wall_follow/src/left_wall_follow_node.cpp
 * @Description: Read https://f1tenth-coursekit.readthedocs.io/en/latest/assignments/labs/lab3.html for detailed information.
 * All direction representations in this file follow the /LaserScan frame. A detailed explanation about frames and rigid body transformation can be found at https://f1tenth-coursekit.readthedocs.io/en/latest/lectures/ModuleA/lecture03.html.
 */

#include "../include/wall_follow/LeftWallFollow.hpp"
LeftWallFollow::LeftWallFollow() : Node("left_wall_follow_node")
{
    // declare parameters.
    ...
    subscription_laser_ = this->create_subscription<sensor_msgs::msg::LaserScan>(lidarscan_topic_, 10, std::bind(&LeftWallFollow::scan_callback, this, std::placeholders::_1));
    ...
    subscriber_control_ = this->create_subscription<std_msgs::msg::String>(control_topic_, 10, std::bind(&LeftWallFollow::control_callback, this, std::placeholders::_1));

    RCLCPP_INFO_STREAM(this->get_logger(), "Node started successfully!");
}

void LeftWallFollow::control_callback(const std_msgs::msg::String::ConstSharedPtr control_msg)
{
...
double LeftWallFollow::get_distance(const std::vector<float>& range_data, const double direction)
{
...
double LeftWallFollow::get_speed(double steering_direction)
{
...
double LeftWallFollow::get_error(const std::vector<float>& range_data)
{
    double dir_a = direction_a_;
    // b-beam always heads towards left side.
    double dir_b = M_PI_2;
...
void LeftWallFollow::pid_control(double error)
{
...
void LeftWallFollow::scan_callback(const sensor_msgs::msg::LaserScan::ConstSharedPtr scan_msg) 
{
    if (!is_sim_start_)
    {
        return;
...
double LeftWallFollow::degrees_to_radians(double degrees)
{
